...
// Hero number count-down animation (600ms, ease-out per design plan)
        ...
        >
            <div className="flex items-start gap-3">
                ...
                <div className="text-right">
                    <div className="text-3xl md:text-4xl font-bold text-rose-400 tabular-nums">
